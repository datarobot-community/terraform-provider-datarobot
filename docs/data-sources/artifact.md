...
page_title: "datarobot_artifact Data Source - datarobot"
subcategory: ""
description: |-
...
# datarobot_artifact (Data Source)
...
- `artifact_id` (String) The artifact version ID to look up.
...
- `creator` (Attributes) User who created the artifact. (see [below for nested schema](#nestedatt--creator))
...
- `code_ref` (Attributes) Reference to source code in the DataRobot catalog. (see [below for nested schema](#nestedatt--spec--container_groups--containers--image_build_config--code_ref))
- `dockerfile` (Attributes) Dockerfile configuration for image builds. (see [below for nested schema](#nestedatt--spec--container_groups--containers--image_build_config--dockerfile))
...
- `datarobot` (Attributes) DataRobot catalog reference. (see [below for nested schema](#nestedatt--spec--container_groups--containers--image_build_config--code_ref--datarobot))
- `provider` (String) Code provider.
- `type` (String) Code reference type.

<a id="nestedatt--spec--container_groups--containers--image_build_config--code_ref--datarobot"></a>
### Nested Schema for `spec.container_groups.containers.image_build_config.code_ref.datarobot`
...
### Nested Schema for `spec.container_groups.containers.security_context`

Read-Only:

- `allow_privilege_escalation` (Boolean) Whether a process can gain more privileges than its parent.
- `capabilities` (Attributes) Linux capabilities to add or drop. (see [below for nested schema](#nestedatt--spec--container_groups--containers--security_context--capabilities))
- `read_only_root_filesystem` (Boolean) Whether the root filesystem is read-only.
- `seccomp_profile` (Attributes) Seccomp profile for the container. (see [below for nested schema](#nestedatt--spec--container_groups--containers--security_context--seccomp_profile))

<a id="nestedatt--spec--container_groups--containers--security_context--capabilities"></a>
### Nested Schema for `spec.container_groups.containers.security_context.capabilities`
...
<a id="nestedatt--spec--container_groups--containers--security_context--seccomp_profile"></a>
### Nested Schema for `spec.container_groups.containers.security_context.seccomp_profile`
