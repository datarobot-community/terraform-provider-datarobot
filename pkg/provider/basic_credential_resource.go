...
// NewBasicCredentialResource returns the new implementation (auth package).
func NewBasicCredentialResource() resource.Resource { return auth.NewBasicCredentialResource() }
